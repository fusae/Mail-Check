...
runtime:
  feedback:
    link_base_url: "https://your-domain.com:5002"  # 修改为你的域名
    link_secret: "your_secret_key_here"            # 签名密钥，请修改为随机字符串
    link_expiry_seconds: 86400                      # 链接有效期
```
...
server {
    ...
    location /feedback {
        proxy_pass http://127.0.0.1:5002/feedback;
...
runtime:
  feedback:
    link_base_url: "https://your-domain.com/feedback"
```
